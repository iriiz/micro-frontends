...
function GeneralData({ handleStep, handleProgress, handleProgressBack }) {
    ...
    return (
        <div className='containerAccordion'>
            ...
            <div className='row'>
                <div className="col-sm-4 space-step">
                    <label className="form-label">Persona Fisica con actividad empresarial</label>
                    <select className="form-select" >
                        <option value="1">No</option>
                        <option value="2">Si</option>
                    </select>
                </div>
                <div className="col-sm-8 space-step">
                </div>
            </div>
            <hr />
            <div className='row'>
